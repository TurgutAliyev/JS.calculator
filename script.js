class Calculator{
    construktor(previousOperandTextElement, currentOperandTextElemenet){
    ...
    updateDisplay(){
       ...
       if(this.operation != null){
        this.previousOperandTextElemenet.innerText = 
...
const calculator = new Calculator(previousOperandTextElement,currentOperandTextElemenet)
